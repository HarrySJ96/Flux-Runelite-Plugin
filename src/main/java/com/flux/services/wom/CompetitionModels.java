...
public class CompetitionModels {
	...
	public static class CompetitionData {
		...
		public CompetitionData(int competitionId, String title, Instant startTime, Instant endTime, LinkedHashMap<String, Integer> sotwLeaderboard, HuntTeamData huntTeamData) {
	...
	public static class HuntTeamData {
		...
		public HuntTeamData(String team1Name, String team2Name, LinkedHashMap<String, Double> team1Leaderboard, LinkedHashMap<String, Double> team2Leaderboard, int team1TotalScore, int team2TotalScore) {
	...
	public enum EventType {
		SOTW("sotw", "sotw"), BOTM("botm", "botm"), HUNT("the hunt", "hunt");
