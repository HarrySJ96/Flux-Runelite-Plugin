...
public class AdminHubCard extends FluxCard {
	...
	private void buildUI() {
		...
		ConfigField[] configFields = {new ConfigField("Roll Call Active", "rollCallActive", true), new ConfigField("BOTM Password", "botm_password", false), new ConfigField("BOTM GDoc URL", "botmGdocUrl", false), new ConfigField("Clan Login Message", "clan_login_message", false), new ConfigField("Plugin Announcement", "plugin_announcement_message", false), new ConfigField("Hunt GDoc URL", "hunt_gdoc_url", false), new ConfigField("Hunt Passwords", "hunt_passwords", false)};
