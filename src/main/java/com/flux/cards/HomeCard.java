...
public class HomeCard extends FluxCard {
	...
	private void addAnnouncementsSection() {
		...
		announcementsPane.setMaximumSize(new Dimension(Integer.MAX_VALUE, announcementsPane.getPreferredSize().height));
	...
	private void addLinksSection() {
		...
		LinkButton[] linkButtons = {new LinkButton("Flux Clan Server", "/discord.png", "https://discord.gg/pTxsfJMNRJ"), new LinkButton("Roll Call", "/discord.png", "discord://discord.com/channels/414435426007384075/636902420403847168"), new LinkButton("Name Changes", "/discord.png", "discord://discord.com/channels/414435426007384075/415499145017557032"), new LinkButton("Announcements", "/discord.png", "discord://discord.com/channels/414435426007384075/1349697176183246868"), new LinkButton("Events", "/discord.png", "discord://discord.com/channels/414435426007384075/414458243499425792"), new LinkButton("Wise Old Man", "/wom.png", "https://wiseoldman.net/groups/141")};
		addLinkButtons(linkButtons);
	}

	private JScrollPane createEventsTable() {
		String[] columnNames = {"Event", "Status"};
		Object[][] rowData = {{"BOTM", "Idle"}, {"SOTW", "Idle"}, {"The Hunt", "Idle"}};
	...
	private void configureScrollPane(JScrollPane scrollPane, JTable table) {
		...
		scrollPane.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(GRID_COLOR, 1, true), BorderFactory.createEmptyBorder(10, 10, 10, 10)));
	}
