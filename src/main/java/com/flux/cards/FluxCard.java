...
public abstract class FluxCard extends JPanel implements Scrollable {
	...
	protected JLabel createWrappedLabel(String text, Font font, Color color) {
		String html = String.format("<html><div style='text-align: center; word-wrap: break-word;'>%s</div></html>", text);
	...
	protected JLabel createWrappedLabelWithUnderline(String text, Font font, Color color) {
		String htmlText = String.format("<html><div style='text-align: center; word-wrap: break-word;'><u>%s</u></div></html>", text);
	...
	protected void updateWrappedLabelText(JLabel label, String text, boolean underline) {
		String format = underline ? "<html><div style='text-align: center; word-wrap: break-word;'><u>%s</u></div></html>" : "<html><div style='text-align: center; word-wrap: break-word;'>%s</div></html>";
	...
	protected InverseCornerButton createLinkButton(LinkButton linkButton) {
		InverseCornerButton button = InverseCornerButton.withLabelImageAndUrl(linkButton.label, linkButton.iconPath, linkButton.url);
